                        ...
                        return Stack(
                          ...
                          children: [
                            controller.isImagePulledFromStorage
                                ...
                                null ||
                                StorageService.to.universityPhotoUrl!.isEmpty
                                ?  const CircleAvatar(
                                radius: 30,
                                backgroundColor : Colors.indigo,
                                child: Icon(
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: IconButton(
                          icon: const Icon(Icons.add_a_photo), color: Colors.white, onPressed: () {
  ...
  Widget buildsField(int i) {
    return ListTile(
      ...
      title: Autocomplete(
        ...
        // <- Magic!
        initialValue: TextEditingValue(text: controller.items.length > i
        ...
        optionsBuilder: (TextEditingValue textEditingValue) {
          ...
          return controller.collageList.where((CollageModel model) {
            return model.collageNameEn!.toLowerCase().contains(
