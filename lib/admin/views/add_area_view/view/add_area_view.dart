...
class AddAreaView extends StatelessWidget {
  AddAreaView({Key? key}) : super(key: key);

   final _formKey = GlobalKey<FormState>();
   final controller = Get.find<AddAreaController>();
     ...
     showDialog(
         ...
         builder: (context) {
           return AlertDialog(
             ...
             content: const Text('Would you like to Upload Area ? '),
             actions: [
               TextButton(
